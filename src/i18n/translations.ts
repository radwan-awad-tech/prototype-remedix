...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    reminder_late: 'Late check-ins (after 08:05) require a reason for HR.',
    reminder_missing: 'Missing check-outs from previous days must be corrected via "Correction Requests".',
    reminder_policy: 'Policy: 15-minute grace window applies to all standard shifts.',
    ...
    select_role_demo: 'Select Role (Demo Only)',
  ...
  ar: {
    ...
    reminder_late: 'تسجيل الدخول المتأخر (بعد 08:05) يت يتطلب سبباً للموارد البشرية.',
    reminder_missing: 'يجب تصحيح تسجيلات الخروج المفقودة من الأيام السابقة عبر "طلبات التصحيح".',
    reminder_policy: 'السياسة: تنطبق فترة سماح مدتها 15 دقيقة على جميع المناوبات القياسية.',
    ...
    select_role_demo: 'اختر الدور (للعرض فقط)',
